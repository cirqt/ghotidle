"""
Django settings for ghotidle_backend project.
...
ROOT_URLCONF = 'ghotidle_backend.urls'
...
WSGI_APPLICATION = 'ghotidle_backend.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'ghodb'),
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'game.authentication.CsrfExemptSessionAuthentication',  # Custom session auth without CSRF
    ],
}
